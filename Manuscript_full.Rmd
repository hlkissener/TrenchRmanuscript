---
title: 'TrenchR: an R package for modular and accessbile microclimate and biophysical ecology'
author: 
...
We implement the estimate assuming that conductive heat exchange occurs down to a soil depth of 2.5cm. We use this value rather than skin thickness, which results in rapid conduction and does not readily reach steady state conditions.

```{r}
Qcond <- rep(NA, 24)
for(hr in 1:24) {
  
  Qcond[hr] <- Qconduction_animal(T_g = Ts[hr] + 273.15, T_b = Ta_liz[hr] + 273.15, d = 0.025, K = K, A = A, proportion = psa_g)
...
Thus, the energy balance was dominated by heat gain from contact with the warmer surface. 
...
Add? Conceptualization, Project Administration, Software, Writing – Original Draft Preparation, Writing – Review & Editing
