...
for (ind in 1:nrow(dat)) {
  ...
  out <- Tb_Gates(A = A, D = 0.0211/3, psa_dir = 0.5, psa_ref = 1-0.5, psa_air = 1, psa_g = 0.0, T_g = dat$SoilTemp[ind] + 273, T_a = dat$Tgrass[ind] + 273, Qabs = A * 0.66 * dat$Rad[ind], epsilon = 0.95, H_L = dat$H_L[ind], ef = 1.3, K = 0.15)
