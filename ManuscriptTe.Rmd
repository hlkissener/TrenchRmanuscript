...
u_z=function(z, d=0.229, z_0=0.0208, u_star= 0.114, k=0.41) u_star/k*log((z-d)/z_0)
...
#surface roughness
z0= apply(C1.hr[, c("Wind0.25m","Wind0.5m","Wind1m","Wind1.5m")], FUN=surface_roughness, MARGIN=1, zr=c(0.25,0.5,1.5,1.5))

z.seq <- seq(0, 2, by = 0.1)

for(hr in 1:24){
t.seq1 <- air_temp_profile_neutral(T_r=C1.hr[hr,"Air0.5m"], zr=0.5, z0=0.02, z=2, T_s=C1.hr[hr,"Soil"])
t.seq2 <- air_temp_profile(T_r=C1.hr[hr,"Air0.5m"], u_r=C1.hr[hr,"Wind0.5m"], zr=0.5, z0=0.02, z=2, T_s=C1.hr[hr,"Soil"])
t.seq3 <- air_temp_profile_segment(T_r=C1.hr[hr, c("Air0.25m","Air0.5m","Air1.0m","Air1.5m")],u_r=C1.hr[hr, c("Wind0.25m","Wind0.5m","Wind1m","Wind1.5m")], zr=c(0.25,0.5,1,1.5), z0=0.02, z=2, T_s=C1.hr[hr,"Soil"])

u.seq1<- wind_speed_profile_neutral(u_r=C1.hr[hr,"Wind0.5m"], zr=0.5, z0=0.02, z=2)
u.seq2<- wind_speed_profile(u_r=C1.hr[hr,"Wind0.5m"], zr=0.5, z0=0.02, z=2)
u.seq3<- wind_speed_profile_segment(u_r=C1.hr[hr, c("Wind0.25m","Wind0.5m","Wind1m","Wind1.5m")], zr=c(0.25,0.5,1,1.5), z0=0.02, z=2)
}
